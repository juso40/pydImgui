...
PYBIND11_MODULE(pyd_imgui, pyd_imgui)
{
	...
	pyd_imgui.def("toggle_wnd_proc", &toggleWndProc, py::return_value_policy::reference);
	...
	pyd_imgui.def("get_style", &ImGui::GetStyle
				  , py::return_value_policy::reference);
	pyd_imgui.def("new_frame", &ImGui::NewFrame, py::call_guard<py::gil_scoped_release>()
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_frame", &ImGui::EndFrame, py::call_guard<py::gil_scoped_release>()
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("render", &ImGui::Render, py::call_guard<py::gil_scoped_release>()
				  , py::return_value_policy::automatic_reference);
	...
	pyd_imgui.def("get_content_region_avail", &ImGui::GetContentRegionAvail
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_content_region_avail_width", &ImGui::GetContentRegionAvailWidth
				  , py::return_value_policy::automatic_reference);
	...
	pyd_imgui.def("get_scroll_max_y", &ImGui::GetScrollMaxY
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_x", [](float f) {ImGui::SetScrollX(f); }
				  , py::arg("scroll_x")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_y", [](float f) {ImGui::SetScrollY(f); }
				  , py::arg("scroll_y")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_here", &ImGui::SetScrollHere
				  , py::arg("center_y_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_from_pos_y", [](float local_y, float center_y_ratio) {ImGui::SetScrollFromPosY(local_y, center_y_ratio); }
				  , py::arg("pos_y")
				  , py::arg("center_y_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	...
	pyd_imgui.def("end_combo", &ImGui::EndCombo
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float", [](const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float2", [](const char* label, std::array<float, 2>& v, float v_speed, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float3", [](const char* label, std::array<float, 3>& v, float v_speed, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float4", [](const char* label, std::array<float, 4>& v, float v_speed, float v_min, float v_max, const char* format, float power) {
	...
	pyd_imgui.def("drag_float_range2", [](const char* label, float* v_current_min, float* v_current_max, float v_speed, float v_min, float v_max, const char* format, const char* format_max, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v_current_min, v_current_max);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int", [](const char* label, int* v, float v_speed, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int2", [](const char* label, std::array<int, 2>& v, float v_speed, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int3", [](const char* label, std::array<int, 3>& v, float v_speed, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int4", [](const char* label, std::array<int, 4>& v, float v_speed, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int_range2", [](const char* label, int* v_current_min, int* v_current_max, float v_speed, int v_min, int v_max, const char* format, const char* format_max) {
		...
		return std::make_tuple(ret, v_current_min, v_current_max);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format_max") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_scalar", [](const char* label, ImGuiDataType data, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power) {
		return ImGui::DragScalar(label, data, p_data, v_speed, p_min, p_max, format, power); }
				  , py::arg("label")
			, py::arg("data_type")
			, py::arg("v")
			, py::arg("v_speed")
			...
			, py::arg("power") = 1.0f
			, py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_scalar_n", [](const char* label, ImGuiDataType data, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, const char* format, float power) {
		return ImGui::DragScalarN(label, data, p_data, components, v_speed, p_min, p_max, format, power); }
				  , py::arg("label")
			, py::arg("data_type")
			, py::arg("v")
			, py::arg("components")
			...
			, py::arg("power") = 1.0f
			, py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float", [](const char* label, float* v, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float2", [](const char* label, std::array<float, 2>& v, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float3", [](const char* label, std::array<float, 3>& v, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float4", [](const char* label, std::array<float, 4>& v, float v_min, float v_max, const char* format, float power) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("power") = 1.0f
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_angle", [](const char* label, float* v_rad, float v_degrees_min, float v_degrees_max) {
		...
		return std::make_tuple(ret, v_rad);
				  ...
				  , py::arg("label")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int", [](const char* label, int* v, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int2", [](const char* label, std::array<int, 2>& v, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int3", [](const char* label, std::array<int, 3>& v, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int4", [](const char* label, std::array<int, 4>& v, int v_min, int v_max, const char* format) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("format") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_scalar", [](const char* label, ImGuiDataType data, void* p_data, const void* p_min, const void* p_max, const char* format, float power) {return ImGui::SliderScalar(label, data, p_data, p_min, p_max, format, power); }
				  , py::arg("label")
				  , py::arg("data_type")
				  , py::arg("v")
				  , py::arg("v_min")
				  ...
				  , py::arg("power") = 1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_scalar_n", [](const char* label, ImGuiDataType data, void* v, int components, const void* v_min, const void* v_max, const char* format, float power) {
		return ImGui::SliderScalarN(label, data, v, components, v_min, v_max, format, power);
				  }
				  , py::arg("label")
					  , py::arg("data_type")
					  , py::arg("v")
	...
	pyd_imgui.def("v_slider_float", [](const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("v_slider_int", [](const char* label, const ImVec2& size, int* v, int v_min, int v_max, const char* format) {
	...
	pyd_imgui.def("v_slider_scalar", &ImGui::VSliderScalar
				  ...
				  , py::arg("power") = 1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float", [](const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float2", [](const char* label, std::array<float, 2>& v, const char* format, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float3", [](const char* label, std::array<float, 3>& v, const char* format, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float4", [](const char* label, std::array<float, 4>& v, const char* format, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int", [](const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int2", [](const char* label, std::array<int, 2>& v, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int3", [](const char* label, std::array<int, 3>& v, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int4", [](const char* label, std::array<int, 4>& v, ImGuiInputTextFlags extra_flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("extra_flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_double", [](const char* label, double* v, double step, double step_fast, const char* format, ImGuiInputTextFlags extra_flags) {
	...
	pyd_imgui.def("tree_pop", &ImGui::TreePop
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_advance_to_label_pos", &ImGui::TreeAdvanceToLabelPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_tree_node_to_label_spacing", &ImGui::GetTreeNodeToLabelSpacing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_tree_node_open", &ImGui::SetNextTreeNodeOpen
				  , py::arg("is_open")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("collapsing_header", py::overload_cast<const char*, ImGuiTreeNodeFlags>(&ImGui::CollapsingHeader)
				  ...
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("collapsing_header", [](const char* label, bool* p_open, ImGuiTreeNodeFlags flags) {
	...
	pyd_imgui.def("selectable", [](const char* label, bool* p_selected, ImGuiSelectableFlags flags, const ImVec2& size) {
		...
		return std::make_tuple(ret, p_selected);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("size") = ImVec2(0, 0)
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("list_box_header", py::overload_cast<const char*, const ImVec2&>(&ImGui::ListBoxHeader)
				  , py::arg("label")
				  , py::arg("size") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("list_box_header", py::overload_cast<const char*, int, int>(&ImGui::ListBoxHeader)
				  , py::arg("label")
				  , py::arg("items_count")
				  , py::arg("height_in_items") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("list_box_footer", &ImGui::ListBoxFooter
				  , py::return_value_policy::automatic_reference);
	...
	pyd_imgui.def("begin_popup_context_item", &ImGui::BeginPopupContextItem
				  ...
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup_context_window", [](const char* str_id, ImGuiMouseButton mb, bool over_items) {return ImGui::BeginPopupContextWindow(str_id, mb, over_items); }
				  , py::arg("str_id") = nullptr
				  , py::arg("mouse_button") = 1
	...
	pyd_imgui.def("get_frame_count", &ImGui::GetFrameCount
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_overlay_draw_list", &ImGui::GetOverlayDrawList
				  , py::return_value_policy::automatic_reference);
	...
	py::enum_<ImGuiSliderFlags_>(pyd_imgui, "SliderFlags", py::arithmetic())
		...
		.value("SLIDER_FLAGS_INVALID_MASK_", ImGuiSliderFlags_InvalidMask_)
		.export_values();
	...
	py::enum_<ImGuiButtonFlags_>(pyd_imgui, "ButtonFlags", py::arithmetic())
		...
		.value("BUTTON_FLAGS_MOUSE_BUTTON_MASK_", ImGuiButtonFlags_MouseButtonMask_)
		.value("BUTTON_FLAGS_MOUSE_BUTTON_DEFAULT_", ImGuiButtonFlags_MouseButtonDefault_)
		.export_values();
	...
	ListClipper.def("begin", &ImGuiListClipper::Begin
					...
					, py::arg("items_height") = -1.0f
					, py::return_value_policy::automatic_reference);
	ListClipper.def("end", &ImGuiListClipper::End, py::call_guard<py::gil_scoped_release>()
					, py::return_value_policy::automatic_reference);
