...
PYBIND11_MODULE(pyd_imgui, pyd_imgui)
{
	...
	template_ImVector<char>(pyd_imgui, "Vector_char");
	template_ImVector<float>(pyd_imgui, "Vector_float");
	template_ImVector<unsigned char>(pyd_imgui, "Vector_unsignedchar");
	template_ImVector<unsigned short>(pyd_imgui, "Vector_unsignedshort");
	template_ImVector<ImDrawCmd>(pyd_imgui, "Vector_DrawCmd");
	template_ImVector<ImDrawVert>(pyd_imgui, "Vector_DrawVert");
	template_ImVector<ImFontGlyph>(pyd_imgui, "Vector_FontGlyph");

	py::class_<ImVec2> Vec2(pyd_imgui, "Vec2");
	...
	py::class_<ImVec4> Vec4(pyd_imgui, "Vec4");
	...
	pyd_imgui.def("create_context", &ImGui::CreateContext
				  , py::arg("shared_font_atlas") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("destroy_context", &ImGui::DestroyContext
				  , py::arg("ctx") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_current_context", &ImGui::GetCurrentContext
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_current_context", &ImGui::SetCurrentContext
				  , py::arg("ctx")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_io", &ImGui::GetIO
				  , py::return_value_policy::reference);
	pyd_imgui.def("get_style", &ImGui::GetStyle
				  , py::return_value_policy::reference);
	pyd_imgui.def("new_frame", &ImGui::NewFrame
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_frame", &ImGui::EndFrame
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("render", &ImGui::Render
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_draw_data", &ImGui::GetDrawData
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_demo_window", [](bool* p_open) {
		ImGui::ShowDemoWindow(p_open);
		return p_open;
				  }
				  , py::arg("p_open") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_metrics_window", [](bool* p_open) {
		ImGui::ShowMetricsWindow(p_open);
		return p_open;
				  }
				  , py::arg("p_open") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_about_window", [](bool* p_open) {
		ImGui::ShowAboutWindow(p_open);
		return p_open;
				  }
				  , py::arg("p_open") = nullptr
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_style_editor", &ImGui::ShowStyleEditor
				  , py::arg("ref") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_style_selector", &ImGui::ShowStyleSelector
				  , py::arg("label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_font_selector", &ImGui::ShowFontSelector
				  , py::arg("label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("show_user_guide", &ImGui::ShowUserGuide
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_version", &ImGui::GetVersion
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("style_colors_dark", &ImGui::StyleColorsDark
				  , py::arg("dst") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("style_colors_light", &ImGui::StyleColorsLight
				  , py::arg("dst") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("style_colors_classic", &ImGui::StyleColorsClassic
				  , py::arg("dst") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin", [](const char* name, bool* p_open, ImGuiWindowFlags flags) {
		...
		return std::make_tuple(ret, p_open);
				  ...
				  , py::arg("name")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end", &ImGui::End
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_child", py::overload_cast<const char*, const ImVec2&, bool, ImGuiWindowFlags>(&ImGui::BeginChild)
				  , py::arg("str_id")
				  , py::arg("size") = ImVec2(0, 0)
				  , py::arg("border") = false
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_child", py::overload_cast<ImGuiID, const ImVec2&, bool, ImGuiWindowFlags>(&ImGui::BeginChild)
				  , py::arg("id")
				  , py::arg("size") = ImVec2(0, 0)
				  , py::arg("border") = false
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_child", &ImGui::EndChild
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_window_appearing", &ImGui::IsWindowAppearing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_window_collapsed", &ImGui::IsWindowCollapsed
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_window_focused", &ImGui::IsWindowFocused
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_window_hovered", &ImGui::IsWindowHovered
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_draw_list", &ImGui::GetWindowDrawList
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_pos", &ImGui::GetWindowPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_size", &ImGui::GetWindowSize
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_width", &ImGui::GetWindowWidth
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_height", &ImGui::GetWindowHeight
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_pos", &ImGui::SetNextWindowPos
				  , py::arg("pos")
				  , py::arg("cond") = 0
				  , py::arg("pivot") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_size", &ImGui::SetNextWindowSize
				  , py::arg("size")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_content_size", &ImGui::SetNextWindowContentSize
				  , py::arg("size")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_collapsed", &ImGui::SetNextWindowCollapsed
				  , py::arg("collapsed")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_focus", &ImGui::SetNextWindowFocus
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_window_bg_alpha", &ImGui::SetNextWindowBgAlpha
				  , py::arg("alpha")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_pos", py::overload_cast<const ImVec2&, ImGuiCond>(&ImGui::SetWindowPos)
				  , py::arg("pos")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_size", py::overload_cast<const ImVec2&, ImGuiCond>(&ImGui::SetWindowSize)
				  , py::arg("size")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_collapsed", py::overload_cast<bool, ImGuiCond>(&ImGui::SetWindowCollapsed)
				  , py::arg("collapsed")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_focus", py::overload_cast<>(&ImGui::SetWindowFocus)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_font_scale", &ImGui::SetWindowFontScale
				  , py::arg("scale")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_pos", py::overload_cast<const char*, const ImVec2&, ImGuiCond>(&ImGui::SetWindowPos)
				  , py::arg("name")
				  , py::arg("pos")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_size", py::overload_cast<const char*, const ImVec2&, ImGuiCond>(&ImGui::SetWindowSize)
				  , py::arg("name")
				  , py::arg("size")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_collapsed", py::overload_cast<const char*, bool, ImGuiCond>(&ImGui::SetWindowCollapsed)
				  , py::arg("name")
				  , py::arg("collapsed")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_window_focus", py::overload_cast<const char*>(&ImGui::SetWindowFocus)
				  , py::arg("name")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_content_region_avail", &ImGui::GetContentRegionAvail
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_content_region_max", &ImGui::GetContentRegionMax
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_content_region_min", &ImGui::GetWindowContentRegionMin
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_content_region_max", &ImGui::GetWindowContentRegionMax
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_window_content_region_width", &ImGui::GetWindowContentRegionWidth
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_scroll_x", &ImGui::GetScrollX
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_scroll_y", &ImGui::GetScrollY
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_x", [](float f) {return ImGui::SetScrollX(f); }
				  , py::arg("scroll_x")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_y", [](float f) {return ImGui::SetScrollY(f); }
				  , py::arg("scroll_y")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_scroll_max_x", &ImGui::GetScrollMaxX
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_scroll_max_y", &ImGui::GetScrollMaxY
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_here_x", &ImGui::SetScrollHereX
				  , py::arg("center_x_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_here_y", &ImGui::SetScrollHereY
				  , py::arg("center_y_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_from_pos_x", [](float loc_x, float cent_x) {ImGui::SetScrollFromPosX(loc_x, cent_x); }
				  , py::arg("local_x")
				  , py::arg("center_x_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_scroll_from_pos_y", [](float loc_y, float cent_y) {ImGui::SetScrollFromPosY(loc_y, cent_y); }
				  , py::arg("local_y")
				  , py::arg("center_y_ratio") = 0.5f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_font", &ImGui::PushFont
				  , py::arg("font")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_font", &ImGui::PopFont
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_style_color", py::overload_cast<ImGuiCol, ImU32>(&ImGui::PushStyleColor)
				  , py::arg("idx")
				  , py::arg("col")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_style_color", py::overload_cast<ImGuiCol, const ImVec4&>(&ImGui::PushStyleColor)
				  , py::arg("idx")
				  , py::arg("col")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_style_color", &ImGui::PopStyleColor
				  , py::arg("count") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_style_var", py::overload_cast<ImGuiStyleVar, float>(&ImGui::PushStyleVar)
				  , py::arg("idx")
				  , py::arg("val")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_style_var", py::overload_cast<ImGuiStyleVar, const ImVec2&>(&ImGui::PushStyleVar)
				  , py::arg("idx")
				  , py::arg("val")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_style_var", &ImGui::PopStyleVar
				  , py::arg("count") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_allow_keyboard_focus", &ImGui::PushAllowKeyboardFocus
				  , py::arg("allow_keyboard_focus")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_allow_keyboard_focus", &ImGui::PopAllowKeyboardFocus
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_button_repeat", &ImGui::PushButtonRepeat
				  , py::arg("repeat")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_button_repeat", &ImGui::PopButtonRepeat
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_item_width", &ImGui::PushItemWidth
				  , py::arg("item_width")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_item_width", &ImGui::PopItemWidth
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_item_width", &ImGui::SetNextItemWidth
				  , py::arg("item_width")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("calc_item_width", &ImGui::CalcItemWidth
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_text_wrap_pos", &ImGui::PushTextWrapPos
				  , py::arg("wrap_local_pos_x") = 0.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_text_wrap_pos", &ImGui::PopTextWrapPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_font", &ImGui::GetFont
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_font_size", &ImGui::GetFontSize
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_font_tex_uv_white_pixel", &ImGui::GetFontTexUvWhitePixel
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_color_u32", py::overload_cast<ImGuiCol, float>(&ImGui::GetColorU32)
				  , py::arg("idx")
				  , py::arg("alpha_mul") = 1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_color_u32", py::overload_cast<const ImVec4&>(&ImGui::GetColorU32)
				  , py::arg("col")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_color_u32", py::overload_cast<ImU32>(&ImGui::GetColorU32)
				  , py::arg("col")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_style_color_vec4", &ImGui::GetStyleColorVec4
				  , py::arg("idx")
				  , py::return_value_policy::reference);
	pyd_imgui.def("separator", &ImGui::Separator
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("same_line", &ImGui::SameLine
				  , py::arg("offset_from_start_x") = 0.0f
				  , py::arg("spacing") = -1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("new_line", &ImGui::NewLine
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("spacing", &ImGui::Spacing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("dummy", &ImGui::Dummy
				  , py::arg("size")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("indent", &ImGui::Indent
				  , py::arg("indent_w") = 0.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("unindent", &ImGui::Unindent
				  , py::arg("indent_w") = 0.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_group", &ImGui::BeginGroup
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_group", &ImGui::EndGroup
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_cursor_pos", &ImGui::GetCursorPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_cursor_pos_x", &ImGui::GetCursorPosX
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_cursor_pos_y", &ImGui::GetCursorPosY
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_cursor_pos", &ImGui::SetCursorPos
				  , py::arg("local_pos")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_cursor_pos_x", &ImGui::SetCursorPosX
				  , py::arg("local_x")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_cursor_pos_y", &ImGui::SetCursorPosY
				  , py::arg("local_y")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_cursor_start_pos", &ImGui::GetCursorStartPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_cursor_screen_pos", &ImGui::GetCursorScreenPos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_cursor_screen_pos", &ImGui::SetCursorScreenPos
				  , py::arg("pos")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("align_text_to_frame_padding", &ImGui::AlignTextToFramePadding
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_text_line_height", &ImGui::GetTextLineHeight
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_text_line_height_with_spacing", &ImGui::GetTextLineHeightWithSpacing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_frame_height", &ImGui::GetFrameHeight
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_frame_height_with_spacing", &ImGui::GetFrameHeightWithSpacing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_id", py::overload_cast<const char*>(&ImGui::PushID)
				  , py::arg("str_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_id", py::overload_cast<const char*, const char*>(&ImGui::PushID)
				  , py::arg("str_id_begin")
				  , py::arg("str_id_end")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_id", py::overload_cast<const void*>(&ImGui::PushID)
				  , py::arg("ptr_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_id", py::overload_cast<int>(&ImGui::PushID)
				  , py::arg("int_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_id", &ImGui::PopID
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_id", py::overload_cast<const char*>(&ImGui::GetID)
				  , py::arg("str_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_id", py::overload_cast<const char*, const char*>(&ImGui::GetID)
				  , py::arg("str_id_begin")
				  , py::arg("str_id_end")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_id", py::overload_cast<const void*>(&ImGui::GetID)
				  , py::arg("ptr_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("text_unformatted", &ImGui::TextUnformatted
				  , py::arg("text")
				  , py::arg("text_end") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("text", [](const char* fmt) {
		ImGui::Text(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("text_colored", [](const ImVec4& col, const char* fmt) {
		...
		return;
				  ...
				  , py::arg("col")
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("text_disabled", [](const char* fmt) {
		ImGui::TextDisabled(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("text_wrapped", [](const char* fmt) {
		ImGui::TextWrapped(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("label_text", [](const char* label, const char* fmt) {
		...
		return;
				  ...
				  , py::arg("label")
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("bullet_text", [](const char* fmt) {
		ImGui::BulletText(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("button", &ImGui::Button
				  , py::arg("label")
				  , py::arg("size") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("small_button", &ImGui::SmallButton
				  , py::arg("label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("invisible_button", &ImGui::InvisibleButton
				  , py::arg("str_id")
				  , py::arg("size")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("arrow_button", &ImGui::ArrowButton
				  , py::arg("str_id")
				  , py::arg("dir")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("image", &ImGui::Image
				  ...
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("image_button", &ImGui::ImageButton
				  , py::arg("user_texture_id")
				  , py::arg("size")
				  , py::arg("uv0") = ImVec2(0, 0)
				  , py::arg("uv1") = ImVec2(1, 1)
				  ...
				  , py::arg("tint_col") = ImVec4(1, 1, 1, 1)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("checkbox", [](const char* label, bool* v) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  , py::arg("v")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("checkbox_flags", [](const char* label, int* flags, int flags_value) {
		...
		return std::make_tuple(ret, flags);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags_value")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("checkbox_flags", [](const char* label, unsigned int* flags, unsigned int flags_value) {
		auto ret = ImGui::CheckboxFlags(label, flags, flags_value);
		return std::make_tuple(ret, flags);
				  }
				  , py::arg("label")
					  ...
					  , py::arg("flags_value")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("radio_button", py::overload_cast<const char*, bool>(&ImGui::RadioButton)
				  , py::arg("label")
				  , py::arg("active")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("radio_button", [](const char* label, int* v, int v_button) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("v_button")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("progress_bar", &ImGui::ProgressBar
				  , py::arg("fraction")
				  , py::arg("size_arg") = ImVec2(-FLT_MIN, 0)
				  , py::arg("overlay") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("bullet", &ImGui::Bullet
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_combo", &ImGui::BeginCombo
				  , py::arg("label")
				  , py::arg("preview_value")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_combo", &ImGui::EndCombo
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float", [](const char* label, float* v, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float2", [](const char* label, std::array<float, 2>& v, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float3", [](const char* label, std::array<float, 3>& v, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float4", [](const char* label, std::array<float, 4>& v, float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_float_range2", [](const char* label, float* v_current_min, float* v_current_max, float v_speed, float v_min, float v_max, const char* format, const char* format_max, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v_current_min, v_current_max);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int", [](const char* label, int* v, float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int2", [](const char* label, std::array<int, 2>& v, float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int3", [](const char* label, std::array<int, 3>& v, float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int4", [](const char* label, std::array<int, 4>& v, float v_speed, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_int_range2", [](const char* label, int* v_current_min, int* v_current_max, float v_speed, int v_min, int v_max, const char* format, const char* format_max, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v_current_min, v_current_max);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_scalar", [](const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
		auto ret = ImGui::DragScalar(label, data_type, p_data, v_speed, p_min, p_max, format, flags);
		return std::make_tuple(ret, p_data);
				  }
				  , py::arg("label")
					  , py::arg("data_type")
					  , py::arg("p_data")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("drag_scalar_n", [](const char* label, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, p_data);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float", [](const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float2", [](const char* label, std::array<float, 2>& v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float3", [](const char* label, std::array<float, 3>& v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_float4", [](const char* label, std::array<float, 4>& v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_angle", [](const char* label, float* v_rad, float v_degrees_min, float v_degrees_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v_rad);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int", [](const char* label, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int2", [](const char* label, std::array<int, 2>& v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int3", [](const char* label, std::array<int, 3>& v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_int4", [](const char* label, std::array<int, 4>& v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_scalar", [](const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, p_data);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("slider_scalar_n", [](const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, p_data);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("v_slider_float", [](const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("v_slider_int", [](const char* label, const ImVec2& size, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("v_slider_scalar", &ImGui::VSliderScalar
				  , py::arg("label")
				  , py::arg("size")
				  , py::arg("data_type")
				  , py::arg("p_data")
				  ...
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float", [](const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float2", [](const char* label, std::array<float, 2>& v, const char* format, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float3", [](const char* label, std::array<float, 3>& v, const char* format, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_float4", [](const char* label, std::array<float, 4>& v, const char* format, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int", [](const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int2", [](const char* label, std::array<int, 2>& v, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int3", [](const char* label, std::array<int, 3>& v, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_int4", [](const char* label, std::array<int, 4>& v, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_double", [](const char* label, double* v, double step, double step_fast, const char* format, ImGuiInputTextFlags flags) {
		...
		return std::make_tuple(ret, v);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_scalar", &ImGui::InputScalar
				  , py::arg("label")
				  , py::arg("data_type")
				  , py::arg("p_data")
				  ...
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_scalar_n", &ImGui::InputScalarN
				  , py::arg("label")
				  , py::arg("data_type")
				  , py::arg("p_data")
				  , py::arg("components")
				  ...
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_edit3", [](const char* label, std::array<float, 3>& col, ImGuiColorEditFlags flags) {
		...
		return std::make_tuple(ret, col);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_edit4", [](const char* label, std::array<float, 4>& col, ImGuiColorEditFlags flags) {
		...
		return std::make_tuple(ret, col);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_picker3", [](const char* label, std::array<float, 3>& col, ImGuiColorEditFlags flags) {
		...
		return std::make_tuple(ret, col);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_picker4", [](const char* label, std::array<float, 4>& col, ImGuiColorEditFlags flags, const float* ref_col) {
		...
		return std::make_tuple(ret, col);
				  ...
				  , py::arg("label")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_button", &ImGui::ColorButton
				  , py::arg("desc_id")
				  , py::arg("col")
				  , py::arg("flags") = 0
				  , py::arg("size") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_color_edit_options", &ImGui::SetColorEditOptions
				  , py::arg("flags")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node", py::overload_cast<const char*>(&ImGui::TreeNode)
				  , py::arg("label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node", [](const char* str_id, const char* fmt) {
		...
		return ret;
				  ...
				  , py::arg("str_id")
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node", [](const void* ptr_id, const char* fmt) {
		...
		return ret;
				  ...
				  , py::arg("ptr_id")
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node_ex", py::overload_cast<const char*, ImGuiTreeNodeFlags>(&ImGui::TreeNodeEx)
				  , py::arg("label")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node_ex", [](const char* str_id, ImGuiTreeNodeFlags flags, const char* fmt) {
		...
		return ret;
				  ...
				  , py::arg("str_id")
					  ...
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_node_ex", [](const void* ptr_id, ImGuiTreeNodeFlags flags, const char* fmt) {
		...
		return ret;
				  ...
				  , py::arg("ptr_id")
					  ...
					  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_push", py::overload_cast<const char*>(&ImGui::TreePush)
				  , py::arg("str_id")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_push", py::overload_cast<const void*>(&ImGui::TreePush)
				  , py::arg("ptr_id") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tree_pop", &ImGui::TreePop
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_tree_node_to_label_spacing", &ImGui::GetTreeNodeToLabelSpacing
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("collapsing_header", py::overload_cast<const char*, ImGuiTreeNodeFlags>(&ImGui::CollapsingHeader)
				  , py::arg("label")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("collapsing_header", [](const char* label, bool* p_visible, ImGuiTreeNodeFlags flags) {
		...
		return std::make_tuple(ret, p_visible);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_next_item_open", &ImGui::SetNextItemOpen
				  , py::arg("is_open")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("selectable", py::overload_cast<const char*, bool, ImGuiSelectableFlags, const ImVec2&>(&ImGui::Selectable)
				  , py::arg("label")
				  , py::arg("selected") = false
				  , py::arg("flags") = 0
				  , py::arg("size") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("selectable", [](const char* label, bool* p_selected, ImGuiSelectableFlags flags, const ImVec2& size) {
		...
		return std::make_tuple(ret, p_selected);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("size") = ImVec2(0, 0)
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_list_box", &ImGui::BeginListBox
				  , py::arg("label")
				  , py::arg("size") = ImVec2(0, 0)
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_list_box", &ImGui::EndListBox
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("value", py::overload_cast<const char*, bool>(&ImGui::Value)
				  , py::arg("prefix")
				  , py::arg("b")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("value", py::overload_cast<const char*, int>(&ImGui::Value)
				  , py::arg("prefix")
				  , py::arg("v")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("value", py::overload_cast<const char*, unsigned int>(&ImGui::Value)
				  , py::arg("prefix")
				  , py::arg("v")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("value", py::overload_cast<const char*, float, const char*>(&ImGui::Value)
				  , py::arg("prefix")
				  , py::arg("v")
				  , py::arg("float_format") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_menu_bar", &ImGui::BeginMenuBar
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_menu_bar", &ImGui::EndMenuBar
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_main_menu_bar", &ImGui::BeginMainMenuBar
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_main_menu_bar", &ImGui::EndMainMenuBar
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_menu", &ImGui::BeginMenu
				  , py::arg("label")
				  , py::arg("enabled") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_menu", &ImGui::EndMenu
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("menu_item", py::overload_cast<const char*, const char*, bool, bool>(&ImGui::MenuItem)
				  , py::arg("label")
				  , py::arg("shortcut") = nullptr
				  , py::arg("selected") = false
				  , py::arg("enabled") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("menu_item", [](const char* label, const char* shortcut, bool* p_selected, bool enabled) {
		...
		return std::make_tuple(ret, p_selected);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("enabled") = true
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_tooltip", &ImGui::BeginTooltip
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_tooltip", &ImGui::EndTooltip
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_tooltip", [](const char* fmt) {
		ImGui::SetTooltip(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup", &ImGui::BeginPopup
				  , py::arg("str_id")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup_modal", [](const char* name, bool* p_open, ImGuiWindowFlags flags) {
		...
		return std::make_tuple(ret, p_open);
				  ...
				  , py::arg("name")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_popup", &ImGui::EndPopup
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("open_popup", &ImGui::OpenPopup
				  , py::arg("str_id")
				  , py::arg("popup_flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("open_popup_on_item_click", &ImGui::OpenPopupOnItemClick
				  , py::arg("str_id") = nullptr
				  , py::arg("popup_flags") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("close_current_popup", &ImGui::CloseCurrentPopup
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup_context_item", &ImGui::BeginPopupContextItem
				  , py::arg("str_id") = nullptr
				  , py::arg("popup_flags") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup_context_window", [](const char* str_id, ImGuiPopupFlags popup_flags) { return ImGui::BeginPopupContextWindow(str_id, popup_flags); }
				  , py::arg("str_id") = nullptr
				  , py::arg("popup_flags") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_popup_context_void", &ImGui::BeginPopupContextVoid
				  , py::arg("str_id") = nullptr
				  , py::arg("popup_flags") = 1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_popup_open", py::overload_cast<const char*, ImGuiPopupFlags>(&ImGui::IsPopupOpen)
				  , py::arg("str_id")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_table", &ImGui::BeginTable
				  , py::arg("str_id")
				  , py::arg("column")
				  , py::arg("flags") = 0
				  ...
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_table", &ImGui::EndTable
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_next_row", &ImGui::TableNextRow
				  , py::arg("row_flags") = 0
				  , py::arg("min_row_height") = 0.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_next_column", &ImGui::TableNextColumn
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_set_column_index", &ImGui::TableSetColumnIndex
				  , py::arg("column_n")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_setup_column", &ImGui::TableSetupColumn
				  , py::arg("label")
				  , py::arg("flags") = 0
				  , py::arg("init_width_or_weight") = 0.0f
				  , py::arg("user_id") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_setup_scroll_freeze", &ImGui::TableSetupScrollFreeze
				  , py::arg("cols")
				  , py::arg("rows")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_headers_row", &ImGui::TableHeadersRow
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_header", &ImGui::TableHeader
				  , py::arg("label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_sort_specs", &ImGui::TableGetSortSpecs
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_column_count", &ImGui::TableGetColumnCount
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_column_index", &ImGui::TableGetColumnIndex
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_row_index", &ImGui::TableGetRowIndex
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_column_name", [](int column_n) {return ImGui::TableGetColumnName(column_n); }
				  , py::arg("column_n") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_get_column_flags", &ImGui::TableGetColumnFlags
				  , py::arg("column_n") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("table_set_bg_color", &ImGui::TableSetBgColor
				  , py::arg("target")
				  , py::arg("color")
				  , py::arg("column_n") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("columns", &ImGui::Columns
				  , py::arg("count") = 1
				  , py::arg("id") = nullptr
				  , py::arg("border") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("next_column", &ImGui::NextColumn
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_column_index", &ImGui::GetColumnIndex
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_column_width", &ImGui::GetColumnWidth
				  , py::arg("column_index") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_column_width", &ImGui::SetColumnWidth
				  , py::arg("column_index")
				  , py::arg("width")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_column_offset", &ImGui::GetColumnOffset
				  , py::arg("column_index") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_column_offset", &ImGui::SetColumnOffset
				  , py::arg("column_index")
				  , py::arg("offset_x")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_columns_count", &ImGui::GetColumnsCount
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_tab_bar", &ImGui::BeginTabBar
				  , py::arg("str_id")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_tab_bar", &ImGui::EndTabBar
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_tab_item", [](const char* label, bool* p_open, ImGuiTabItemFlags flags) {
		...
		return std::make_tuple(ret, p_open);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_tab_item", &ImGui::EndTabItem
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("tab_item_button", &ImGui::TabItemButton
				  , py::arg("label")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_tab_item_closed", &ImGui::SetTabItemClosed
				  , py::arg("tab_or_docked_window_label")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_to_tty", &ImGui::LogToTTY
				  , py::arg("auto_open_depth") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_to_file", &ImGui::LogToFile
				  , py::arg("auto_open_depth") = -1
				  , py::arg("filename") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_to_clipboard", &ImGui::LogToClipboard
				  , py::arg("auto_open_depth") = -1
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_finish", &ImGui::LogFinish
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_buttons", &ImGui::LogButtons
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("log_text", [](const char* fmt) {
		ImGui::LogText(fmt);
		return;
				  }
				  , py::arg("fmt")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_drag_drop_source", &ImGui::BeginDragDropSource
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_drag_drop_payload", &ImGui::SetDragDropPayload
				  , py::arg("type")
				  , py::arg("data")
				  , py::arg("sz")
				  , py::arg("cond") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_drag_drop_source", &ImGui::EndDragDropSource
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_drag_drop_target", &ImGui::BeginDragDropTarget
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("accept_drag_drop_payload", &ImGui::AcceptDragDropPayload
				  , py::arg("type")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_drag_drop_target", &ImGui::EndDragDropTarget
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_drag_drop_payload", &ImGui::GetDragDropPayload
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("push_clip_rect", &ImGui::PushClipRect
				  , py::arg("clip_rect_min")
				  , py::arg("clip_rect_max")
				  , py::arg("intersect_with_current_clip_rect")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("pop_clip_rect", &ImGui::PopClipRect
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_item_default_focus", &ImGui::SetItemDefaultFocus
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_keyboard_focus_here", &ImGui::SetKeyboardFocusHere
				  , py::arg("offset") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_hovered", &ImGui::IsItemHovered
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_active", &ImGui::IsItemActive
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_focused", &ImGui::IsItemFocused
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_clicked", &ImGui::IsItemClicked
				  , py::arg("mouse_button") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_visible", &ImGui::IsItemVisible
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_edited", &ImGui::IsItemEdited
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_activated", &ImGui::IsItemActivated
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_deactivated", &ImGui::IsItemDeactivated
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_deactivated_after_edit", &ImGui::IsItemDeactivatedAfterEdit
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_item_toggled_open", &ImGui::IsItemToggledOpen
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_any_item_hovered", &ImGui::IsAnyItemHovered
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_any_item_active", &ImGui::IsAnyItemActive
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_any_item_focused", &ImGui::IsAnyItemFocused
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_item_rect_min", &ImGui::GetItemRectMin
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_item_rect_max", &ImGui::GetItemRectMax
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_item_rect_size", &ImGui::GetItemRectSize
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_item_allow_overlap", &ImGui::SetItemAllowOverlap
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_main_viewport", &ImGui::GetMainViewport
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_rect_visible", py::overload_cast<const ImVec2&>(&ImGui::IsRectVisible)
				  , py::arg("size")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_rect_visible", py::overload_cast<const ImVec2&, const ImVec2&>(&ImGui::IsRectVisible)
				  , py::arg("rect_min")
				  , py::arg("rect_max")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_time", &ImGui::GetTime
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_frame_count", &ImGui::GetFrameCount
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_background_draw_list", []() {return ImGui::GetBackgroundDrawList(); }
	, py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_foreground_draw_list", []() {return ImGui::GetForegroundDrawList(); }
	, py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_draw_list_shared_data", &ImGui::GetDrawListSharedData
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_style_color_name", &ImGui::GetStyleColorName
				  , py::arg("idx")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_state_storage", &ImGui::SetStateStorage
				  , py::arg("storage")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_state_storage", &ImGui::GetStateStorage
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("calc_list_clipping", [](int items_count, float items_height, int* out_items_display_start, int* out_items_display_end) {
		...
		return std::make_tuple(out_items_display_start, out_items_display_end);
				  ...
				  , py::arg("items_count")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("begin_child_frame", &ImGui::BeginChildFrame
				  , py::arg("id")
				  , py::arg("size")
				  , py::arg("flags") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("end_child_frame", &ImGui::EndChildFrame
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("calc_text_size", &ImGui::CalcTextSize
				  , py::arg("text")
				  , py::arg("text_end") = nullptr
				  , py::arg("hide_text_after_double_hash") = false
				  , py::arg("wrap_width") = -1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_convert_u32_to_float4", &ImGui::ColorConvertU32ToFloat4
				  , py::arg("in")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_convert_float4_to_u32", &ImGui::ColorConvertFloat4ToU32
				  , py::arg("in")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_convert_rg_bto_hsv", [](float r, float g, float b, float& out_h, float& out_s, float& out_v) {
		...
		return std::make_tuple(out_h, out_s, out_v);
				  ...
				  , py::arg("r")
					  ...
					  , py::arg("out_v") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("color_convert_hs_vto_rgb", [](float h, float s, float v, float& out_r, float& out_g, float& out_b) {
		...
		return std::make_tuple(out_r, out_g, out_b);
				  ...
				  , py::arg("h")
					  ...
					  , py::arg("out_b")
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_key_index", &ImGui::GetKeyIndex
				  , py::arg("imgui_key")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_key_down", &ImGui::IsKeyDown
				  , py::arg("user_key_index")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_key_pressed", &ImGui::IsKeyPressed
				  , py::arg("user_key_index")
				  , py::arg("repeat") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_key_released", &ImGui::IsKeyReleased
				  , py::arg("user_key_index")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_key_pressed_amount", &ImGui::GetKeyPressedAmount
				  , py::arg("key_index")
				  , py::arg("repeat_delay")
				  , py::arg("rate")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("capture_keyboard_from_app", &ImGui::CaptureKeyboardFromApp
				  , py::arg("want_capture_keyboard_value") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_down", &ImGui::IsMouseDown
				  , py::arg("button")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_clicked", &ImGui::IsMouseClicked
				  , py::arg("button")
				  , py::arg("repeat") = false
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_released", &ImGui::IsMouseReleased
				  , py::arg("button")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_double_clicked", &ImGui::IsMouseDoubleClicked
				  , py::arg("button")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_hovering_rect", &ImGui::IsMouseHoveringRect
				  , py::arg("r_min")
				  , py::arg("r_max")
				  , py::arg("clip") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_pos_valid", &ImGui::IsMousePosValid
				  , py::arg("mouse_pos") = nullptr
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_any_mouse_down", &ImGui::IsAnyMouseDown
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_mouse_pos", &ImGui::GetMousePos
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_mouse_pos_on_opening_current_popup", &ImGui::GetMousePosOnOpeningCurrentPopup
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("is_mouse_dragging", &ImGui::IsMouseDragging
				  , py::arg("button")
				  , py::arg("lock_threshold") = -1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_mouse_drag_delta", &ImGui::GetMouseDragDelta
				  , py::arg("button") = 0
				  , py::arg("lock_threshold") = -1.0f
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("reset_mouse_drag_delta", &ImGui::ResetMouseDragDelta
				  , py::arg("button") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_mouse_cursor", &ImGui::GetMouseCursor
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_mouse_cursor", &ImGui::SetMouseCursor
				  , py::arg("cursor_type")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("capture_mouse_from_app", &ImGui::CaptureMouseFromApp
				  , py::arg("want_capture_mouse_value") = true
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("get_clipboard_text", &ImGui::GetClipboardText
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("set_clipboard_text", &ImGui::SetClipboardText
				  , py::arg("text")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("load_ini_settings_from_disk", &ImGui::LoadIniSettingsFromDisk
				  , py::arg("ini_filename")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("load_ini_settings_from_memory", &ImGui::LoadIniSettingsFromMemory
				  , py::arg("ini_data")
				  , py::arg("ini_size") = 0
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("save_ini_settings_to_disk", &ImGui::SaveIniSettingsToDisk
				  , py::arg("ini_filename")
				  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("save_ini_settings_to_memory", [](size_t* out_ini_size) {
		auto ret = ImGui::SaveIniSettingsToMemory(out_ini_size);
		return std::make_tuple(ret, out_ini_size);
				  }
				  , py::arg("out_ini_size") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("debug_check_version_and_data_layout", &ImGui::DebugCheckVersionAndDataLayout
				  , py::arg("version_str")
				  , py::arg("sz_io")
				  , py::arg("sz_style")
				  , py::arg("sz_vec2")
				  ...
				  , py::arg("sz_drawidx")
				  , py::return_value_policy::automatic_reference);
	py::enum_<ImGuiWindowFlags_>(pyd_imgui, "WindowFlags", py::arithmetic())
	...
	py::enum_<ImGuiInputTextFlags_>(pyd_imgui, "InputTextFlags", py::arithmetic())
	...
	py::enum_<ImGuiTreeNodeFlags_>(pyd_imgui, "TreeNodeFlags", py::arithmetic())
	...
	py::enum_<ImGuiPopupFlags_>(pyd_imgui, "PopupFlags", py::arithmetic())
	...
	py::enum_<ImGuiSelectableFlags_>(pyd_imgui, "SelectableFlags", py::arithmetic())
	...
	py::enum_<ImGuiComboFlags_>(pyd_imgui, "ComboFlags", py::arithmetic())
	...
	py::enum_<ImGuiTabBarFlags_>(pyd_imgui, "TabBarFlags", py::arithmetic())
	...
	py::enum_<ImGuiTabItemFlags_>(pyd_imgui, "TabItemFlags", py::arithmetic())
	...
	py::enum_<ImGuiTableFlags_>(pyd_imgui, "TableFlags", py::arithmetic())
	...
	py::enum_<ImGuiTableColumnFlags_>(pyd_imgui, "TableColumnFlags", py::arithmetic())
	...
	py::enum_<ImGuiTableRowFlags_>(pyd_imgui, "TableRowFlags", py::arithmetic())
		.value("TABLE_ROW_FLAGS_NONE", ImGuiTableRowFlags_None)
		.value("TABLE_ROW_FLAGS_HEADERS", ImGuiTableRowFlags_Headers)
		.export_values();

	py::enum_<ImGuiTableBgTarget_>(pyd_imgui, "TableBgTarget", py::arithmetic())
	...
	py::enum_<ImGuiFocusedFlags_>(pyd_imgui, "FocusedFlags", py::arithmetic())
	...
	py::enum_<ImGuiHoveredFlags_>(pyd_imgui, "HoveredFlags", py::arithmetic())
	...
	py::enum_<ImGuiDragDropFlags_>(pyd_imgui, "DragDropFlags", py::arithmetic())
	...
	py::enum_<ImGuiDataType_>(pyd_imgui, "DataType", py::arithmetic())
	...
	py::enum_<ImGuiDir_>(pyd_imgui, "Dir", py::arithmetic())
	...
	py::enum_<ImGuiSortDirection_>(pyd_imgui, "SortDirection", py::arithmetic())
	...
	py::enum_<ImGuiKey_>(pyd_imgui, "Key", py::arithmetic())
	...
	py::enum_<ImGuiKeyModFlags_>(pyd_imgui, "KeyModFlags", py::arithmetic())
	...
	py::enum_<ImGuiNavInput_>(pyd_imgui, "NavInput", py::arithmetic())
	...
	py::enum_<ImGuiConfigFlags_>(pyd_imgui, "ConfigFlags", py::arithmetic())
	...
	py::enum_<ImGuiBackendFlags_>(pyd_imgui, "BackendFlags", py::arithmetic())
	...
	py::enum_<ImGuiCol_>(pyd_imgui, "Col", py::arithmetic())
	...
	py::enum_<ImGuiStyleVar_>(pyd_imgui, "StyleVar", py::arithmetic())
	...
	py::enum_<ImGuiButtonFlags_>(pyd_imgui, "ButtonFlags", py::arithmetic())
	...
	py::enum_<ImGuiColorEditFlags_>(pyd_imgui, "ColorEditFlags", py::arithmetic())
	...
	py::enum_<ImGuiSliderFlags_>(pyd_imgui, "SliderFlags", py::arithmetic())
	...
	py::enum_<ImGuiMouseButton_>(pyd_imgui, "MouseButton", py::arithmetic())
	...
	py::enum_<ImGuiMouseCursor_>(pyd_imgui, "MouseCursor", py::arithmetic())
	...
	py::enum_<ImGuiCond_>(pyd_imgui, "Cond", py::arithmetic())
	...
	py::class_<ImNewWrapper> NewWrapper(pyd_imgui, "NewWrapper");
	py::class_<ImGuiStyle> Style(pyd_imgui, "Style");
	...
	Style.def("scale_all_sizes", &ImGuiStyle::ScaleAllSizes
			  , py::arg("scale_factor")
			  , py::return_value_policy::automatic_reference);
	py::class_<ImGuiIO> IO(pyd_imgui, "IO");
	...
	IO.def(py::init<>());
	py::class_<ImGuiInputTextCallbackData> InputTextCallbackData(pyd_imgui, "InputTextCallbackData");
	...
	InputTextCallbackData.def("has_selection", &ImGuiInputTextCallbackData::HasSelection
							  , py::return_value_policy::automatic_reference);
	py::class_<ImGuiSizeCallbackData> SizeCallbackData(pyd_imgui, "SizeCallbackData");
	...
	py::class_<ImGuiPayload> Payload(pyd_imgui, "Payload");
	...
	Payload.def("is_delivery", &ImGuiPayload::IsDelivery
				, py::return_value_policy::automatic_reference);
	py::class_<ImGuiTableColumnSortSpecs> TableColumnSortSpecs(pyd_imgui, "TableColumnSortSpecs");
	...
	py::class_<ImGuiTableSortSpecs> TableSortSpecs(pyd_imgui, "TableSortSpecs");
	...
	py::class_<ImGuiOnceUponAFrame> OnceUponAFrame(pyd_imgui, "OnceUponAFrame");
	OnceUponAFrame.def(py::init<>());
	OnceUponAFrame.def_readwrite("ref_frame", &ImGuiOnceUponAFrame::RefFrame);
	py::class_<ImGuiTextFilter> TextFilter(pyd_imgui, "TextFilter");
	...
	py::class_<ImGuiStorage> Storage(pyd_imgui, "Storage");
	...
	Storage.def("build_sort_by_key", &ImGuiStorage::BuildSortByKey
				, py::return_value_policy::automatic_reference);
	py::class_<ImGuiListClipper> ListClipper(pyd_imgui, "ListClipper");
	...
	ListClipper.def("step", &ImGuiListClipper::Step
					, py::return_value_policy::automatic_reference);
	py::class_<ImColor> Color(pyd_imgui, "Color");
	...
	Color.def("set_hsv", &ImColor::SetHSV
			  ...
			  , py::arg("a") = 1.0f
			  , py::return_value_policy::automatic_reference);
	py::class_<ImDrawCmd> DrawCmd(pyd_imgui, "DrawCmd");
	...
	DrawCmd.def(py::init<>());
	py::class_<ImDrawVert> DrawVert(pyd_imgui, "DrawVert");
	...
	py::class_<ImDrawCmdHeader> DrawCmdHeader(pyd_imgui, "DrawCmdHeader");
	...
	py::class_<ImDrawChannel> DrawChannel(pyd_imgui, "DrawChannel");
	py::class_<ImDrawListSplitter> DrawListSplitter(pyd_imgui, "DrawListSplitter");
	...
	DrawListSplitter.def("set_current_channel", &ImDrawListSplitter::SetCurrentChannel
						 ...
						 , py::arg("channel_idx")
						 , py::return_value_policy::automatic_reference);
	py::enum_<ImDrawCornerFlags_>(pyd_imgui, "DrawCornerFlags", py::arithmetic())
	...
	py::enum_<ImDrawListFlags_>(pyd_imgui, "DrawListFlags", py::arithmetic())
	...
	py::class_<ImDrawList> DrawList(pyd_imgui, "DrawList");
	...
	DrawList.def("prim_vtx", &ImDrawList::PrimVtx
				 ...
				 , py::arg("col")
				 , py::return_value_policy::automatic_reference);
	py::class_<ImDrawData> DrawData(pyd_imgui, "DrawData");
	...
	DrawData.def("scale_clip_rects", &ImDrawData::ScaleClipRects
				 , py::arg("fb_scale")
				 , py::return_value_policy::automatic_reference);
	py::class_<ImFontConfig> FontConfig(pyd_imgui, "FontConfig");
	...
	py::class_<ImFontGlyph> FontGlyph(pyd_imgui, "FontGlyph");
	...
	py::class_<ImFontGlyphRangesBuilder> FontGlyphRangesBuilder(pyd_imgui, "FontGlyphRangesBuilder");
	...
	FontGlyphRangesBuilder.def("build_ranges", &ImFontGlyphRangesBuilder::BuildRanges
							   , py::arg("out_ranges")
							   , py::return_value_policy::automatic_reference);
	py::class_<ImFontAtlasCustomRect> FontAtlasCustomRect(pyd_imgui, "FontAtlasCustomRect");
	...
	FontAtlasCustomRect.def("is_packed", &ImFontAtlasCustomRect::IsPacked
							, py::return_value_policy::automatic_reference);
	py::enum_<ImFontAtlasFlags_>(pyd_imgui, "FontAtlasFlags", py::arithmetic())
	...
	py::class_<ImFontAtlas> FontAtlas(pyd_imgui, "FontAtlas");
	...
	py::class_<ImFont> Font(pyd_imgui, "Font");
	...
	Font.def("is_glyph_range_unused", &ImFont::IsGlyphRangeUnused
			 ...
			 , py::arg("c_last")
			 , py::return_value_policy::automatic_reference);
	py::enum_<ImGuiViewportFlags_>(pyd_imgui, "ViewportFlags", py::arithmetic())
	...
	py::class_<ImGuiViewport> Viewport(pyd_imgui, "Viewport");
	...
	pyd_imgui.def("input_text", [](const char* label, char* data, size_t max_size, ImGuiInputTextFlags flags) {
		max_size++;
		...
		return std::make_tuple(ret, output);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("input_text_multiline", [](const char* label, char* data, size_t max_size, const ImVec2& size, ImGuiInputTextFlags flags) {
		max_size++;
		char* text = (char*)malloc(max_size * sizeof(char));
		strncpy(text, data, max_size);
		...
		return std::make_tuple(ret, output);
				  ...
				  , py::arg("label")
					  ...
					  , py::arg("flags") = 0
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("combo", [](const char* label, int* current_item, std::vector<std::string> items, int popup_max_height_in_items) {
		...
		return std::make_tuple(ret, current_item);
				  ...
				  , py::arg("label")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("list_box", [](const char* label, int* current_item, std::vector<std::string> items, int height_in_items) {
		std::vector<const char*> ptrs;
		for (const std::string& s : items)
		{
			ptrs.push_back(s.c_str());
		...
		return std::make_tuple(ret, current_item);
				  ...
				  , py::arg("label")
					  ...
					  , py::return_value_policy::automatic_reference);
	pyd_imgui.def("plot_lines", [](const char* label, std::vector<float> values, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size) {
	...
	pyd_imgui.def("plot_histogram", [](const char* label, std::vector<float> values, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size) {
	...
	// custom imugui implementations for performance reasons

	pyd_imgui.def("list_box_stretch", [](const char* label, int* current_item, py::list items) {
		bool b_ret = false;

		if (ImGui::BeginListBox(label, ImVec2(-1, -10)))
		{
			for (int i = 0; i < items.size(); i++)
			{
				const bool is_selected = (i == *current_item);
				if (ImGui::Selectable(items[i].cast<std::string>().c_str(), is_selected))
				{
					b_ret = true; *current_item = i;
				}
				if (is_selected)
		...
		return std::make_tuple(b_ret, current_item); }
				  , py::arg("label")
			, py::arg("current_item")
			, py::arg("items")
			, py::return_value_policy::automatic_reference);
...
#ifdef VERSION_INFO
	pyd_imgui.attr("__version__") = VERSION_INFO;
#else
	pyd_imgui.attr("__version__") = "dev";
#endif
}
