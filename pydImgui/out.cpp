...
PYBIND11_MODULE(deargui, deargui)
{
    ...
    , py::return_value_policy::automatic_reference);
    deargui.def("set_scroll_from_pos_x", &ImGui::SetScrollFromPosX
    , py::arg("local_x")
    , py::arg("center_x_ratio") = 0.5f
    , py::return_value_policy::automatic_reference);
    ...
    , py::return_value_policy::automatic_reference);
    deargui.def("table_get_column_name", &ImGui::TableGetColumnName
    , py::arg("column_n") = -1
    , py::return_value_policy::automatic_reference);
    ...
    , py::return_value_policy::automatic_reference);
    deargui.def("get_foreground_draw_list", &ImGui::GetForegroundDrawList
    , py::return_value_policy::automatic_reference);
